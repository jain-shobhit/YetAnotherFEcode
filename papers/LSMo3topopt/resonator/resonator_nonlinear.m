...
while (iter < maxIter)
    ...
    [g, dgdd] = gamma_sensitivity(myAssembly, Mc, Kc, T2c, T3c, omega, uc, Me, Ke, T2e, T3e, sensPhK, sensPhM, to.freeElements);
    ...
    % Compute sensitivity
    % dCdd = SensitivityLibrary.compliance(myMesh, v, Ke, sensPhK) / F0;
    ...
    fprintf("\n%4d %16.4e %16.4e %16.4e %16.4e %16.4e", iter, C, fX, fY, g, A / Atot);
