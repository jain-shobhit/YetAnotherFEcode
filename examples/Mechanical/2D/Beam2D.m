...
% PLOT
mod = 2;
elementPlot = elements(:,ind_elem_plot); % plot only corners (otherwise it's a mess)
figure('units','normalized','position',[.2 .25 .6 .5])
